        ...
        <div className="relative z-10 flex items-center justify-center min-h-[80vh] px-6">
          <div className="max-w-5xl text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-medium">
              A collection of 10,000+ AI-powered workflows for your Shopify
              store. Automate customer support, process refunds, and manage
              orders with intelligent automation.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl p-8 relative overflow-hidden group hover:scale-105 transition-all duration-300 hover:shadow-2xl">
              <div className="relative z-10">
                ...
                <p className="text-white/90 mb-6 text-sm font-medium">
                  Intelligent responses to customer inquiries with 95% accuracy
                </p>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl p-8 relative overflow-hidden group hover:scale-105 transition-all duration-300 hover:shadow-2xl">
              <div className="relative z-10">
                ...
                <p className="text-white/90 mb-6 text-sm font-medium">
                  Automated workflows for refunds, cancellations, and order
                  management
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-bold text-white">
            ...
            <div className="bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl p-8 relative overflow-hidden group hover:scale-105 transition-all duration-300 hover:shadow-2xl">
              <div className="relative z-10">
                ...
                <p className="text-white/90 mb-6 text-sm font-medium">
                  Real-time insights into customer behavior and support patterns
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-bold text-white">
                    Analytics
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
              Native connections for Shopify and Gmail. Secure OAuth and
              resilient webhooks keep your inbox in sync.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
                  ...
                  {[
                    {
                      ...
                      desc: 'Add our app to your Shopify store',
                    },
                    {
                      step: '2',
                      title: 'Approve Gmail access',
                      desc: 'Connect your Gmail account securely',
                    },
                    {
                      step: '3',
                      title: 'Start automating',
                      desc: 'Let AI handle your customer support',
                    },
                  ].map((item, index) => (
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/integrations"
                  className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-full font-bold hover:from-orange-600 hover:to-red-600 transition-all duration-300 hover:scale-105"
                >
                  Connect your store
                </Link>
                <Link
                  href="/inbox"
                  className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-all duration-300 hover:scale-105"
                >
                  See it in action
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 group hover:scale-105 transition-all duration-300">
                ...
                <Link
                  href="/integrations"
                  className="w-full bg-green-600 text-white text-center py-3 px-4 rounded-full text-sm font-bold hover:bg-green-700 transition-all duration-300"
                >
                  Connect
                </Link>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 group hover:scale-105 transition-all duration-300">
                ...
                <Link
                  href="/integrations"
                  className="w-full bg-red-600 text-white text-center py-3 px-4 rounded-full text-sm font-bold hover:bg-red-700 transition-all duration-300"
                >
                  Authorize
                </Link>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 font-medium">
              Join thousands of e-commerce businesses automating their customer
              service
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-gray-400 font-bold text-sm uppercase tracking-wide">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 group hover:scale-105 transition-all duration-300">
              ...
              <Link
                href="/integrations"
                className="w-full border-2 border-gray-300 text-gray-700 text-center py-4 rounded-full font-bold hover:bg-gray-100 transition-all duration-300"
              >
                Get started
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-8 shadow-2xl relative group hover:scale-105 transition-all duration-300">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-white text-orange-500 px-6 py-2 rounded-full text-sm font-black">
                  Most Popular
                </span>
              </div>
              ...
              <div className="text-5xl font-black text-white mb-2">
                {annual ? '$150' : '$175'}
                <span className="text-2xl font-bold text-white/80">/mo</span>
              </div>
              {annual && (
                <div className="text-sm text-white/80 font-medium mb-6">
                  Billed annually
                </div>
              )}
              ...
              <Link
                href="/integrations"
                className="w-full bg-white text-orange-500 text-center py-4 rounded-full font-black hover:bg-gray-100 transition-all duration-300"
              >
                Start free trial
              </Link>
            </div>
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto font-medium">
            Start automating your Shopify customer support today with our
            AI-powered platform.
          </p>
          <Link
            href="/integrations"
            className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-12 py-6 rounded-full text-xl font-black hover:from-orange-600 hover:to-red-600 transition-all duration-300 hover:scale-105"
          >
